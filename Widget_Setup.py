...
class Notebook_Setup(Gtk.Notebook):
    ...
    def __init__(self, proyecto):
        ...
        label = Gtk.Label("Proyecto Gnome")
        ...
        label = Gtk.Label("Proyecto Gnome Ceibal")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(box, label)
        ...
        label = Gtk.Label("Proyecto Sugar")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(box, label)
...
class Gnome_Notebook(Gtk.Notebook):
    ...
    def __init__(self, proyecto):
        ...
        label = Gtk.Label("setup.cfg")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.setupcfg), label)

        self.setupdesktop = Setup_SourceView()
        self.setupdesktop.get_buffer().set_text("")

        label = Gtk.Label("%s.desktop" % self.proyecto["nombre"])
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.setupdesktop), label)

        self.setupmanifest = Setup_SourceView()
        self.setupmanifest.get_buffer().set_text("")

        label = Gtk.Label("MANIFEST")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.setupmanifest), label)

        self.setuppy = Setup_SourceView()
        self.setuppy.get_buffer().set_text("")

        label = Gtk.Label("setup.py")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.setuppy), label)

        self.lanzador = Setup_SourceView()
        self.lanzador.get_buffer().set_text("")

        label = Gtk.Label("lanzador")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.lanzador), label)

        self.desinstalador = Setup_SourceView()
        self.desinstalador.get_buffer().set_text("")

        label = Gtk.Label("desinstalador")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.desinstalador), label)
...
class Sugar_Notebook(Gtk.Notebook):
    ...
    def __init__(self, proyecto):
        ...
        label = Gtk.Label("activity.info")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.activity_sourceview), label)

        label = Gtk.Label("setup.py")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.setup_sourceview), label)
...
class Widget_icon(Gtk.Frame):
    ...
    def __init__(self, tipo="gnome", proyecto=None):
        ...
        boton = get_boton(Gtk.STOCK_DIRECTORY, "Buscar Archivo")
...
class Ceibal_Notebook(Gtk.Notebook):
    ...
    def __init__(self, proyecto):
        ...
        label = Gtk.Label("install.py")
        label.modify_fg(Gtk.StateType.NORMAL, Gdk.color_parse('#000000'))
        self.append_page(get_scroll(self.install), label)
        self.show_all()
